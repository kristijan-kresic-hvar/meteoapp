  ...
  return (
    <div className={`${styles.app} flex`}>
      ...
      <div className="absolute right-10 bottom-10" title="Settings">
        <button type="button" class="transition ease-in-out text-black border-black bg-gray-100 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full p-2.5 text-center inline-flex items-center">
